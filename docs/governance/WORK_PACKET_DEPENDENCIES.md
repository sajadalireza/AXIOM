...
The live repository, Issue `#15`, canonical control documents, accepted Product Owner decisions, and verified GitHub Issue state remain authoritative. Completion of a predecessor never automatically authorizes or activates its successor.
...
| WP-004 | G0 | #15 | WP-003 (#8) | WP-005 (#16) | `active` | 1 | Active only under the recorded Product Owner authorization. |
| WP-005 | G0 | #16 | WP-004 (#15) | WP-101 (#17) | `planned` | 0 | Explicit Product Owner activation after WP-004 acceptance and closure. |
| WP-101 | G1 | #17 | WP-005 (#16) | WP-102 (#18) | `planned` | 0 | Successful WP-005 GO decision plus explicit Product Owner activation. |
...
| WP-201 | G2 | #24 | WP-107 (#23) | WP-202 (#25) | `planned` | 0 | Successful WP-107 GO decision plus explicit Product Owner activation. |
...
- Every activation requires an explicit Product Owner decision and a WIP preflight proving the global WIP result remains exactly one.
